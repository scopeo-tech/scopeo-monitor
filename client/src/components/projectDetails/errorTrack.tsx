...
function ErrorTrack() {
  ...
  return (
    <div>
      ...
      <motion.div
  className="max-w-full mx-auto bg-white rounded-xl shadow-sm border border-gray-100"
  initial={{ opacity: 0 }}
  animate={{ opacity: 1 }}
  transition={{ delay: 0.2 }}
>
  <div className="p-6 border-b border-gray-100">
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-2xl font-semibold text-gray-800">Error Logs</h2>
      </div>
      <div className="flex items-center space-x-3 px-4 py-2 bg-gray-50 rounded-full text-gray-700 font-medium">
  ...
  <div
    className="overflow-y-auto max-h-[70vh] px-6 py-4 bg-gray-50 transition-all duration-300 relative"
  ...
  >
    ...
    {isFetchingNextPage && (
      <motion.div
        ...
        animate={{ opacity: 1 }}
      >
        <div className="inline-flex items-center px-5 py-3 bg-white rounded-lg shadow-sm">
          <svg
          ...
          <span className="font-medium">Loading more errors...</span>
        </div>
      </motion.div>
    )}
  </div>
  ...
  {hasNextPage && (
    <div className="text-center p-6 border-t border-gray-100 bg-white">
      <button
        onClick={() => fetchNextPage()}
        disabled={isFetchingNextPage}
        className="bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition flex items-center justify-center mx-auto font-medium shadow-sm disabled:bg-blue-300"
      >
        {isFetchingNextPage ? (
          <>
            <svg 
