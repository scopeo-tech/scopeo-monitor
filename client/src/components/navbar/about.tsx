        ...
        <div className="container mx-auto px-4 md:px-20 flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 md:pr-10 text-center md:text-left">
            <h1 className="text-3xl md:text-5xl font-semibold mb-6 text-gray-800">
              Proactive{" "}
              <span className="font-serif text-emerald-400">Monitoring </span>
              for Smarter Development
            </h1>
            <p className="text-base md:text-lg text-gray-600">
              At <strong>Scopeo</strong>, we are dedicated to simplifying web
              application monitoring. Our goal is to provide developers with
              real-time insights into their projects, ensuring performance,
              security, and reliability. With a powerful monitoring dashboard
              and integrated backend libraries, we help teams track uptime,
              response times, security threats, and critical errors—all in one
              place. Our lightweight monitoring agent seamlessly integrates into
              any project, collecting essential data without compromising
              privacy or security. Built with cutting-edge technology, our
              solution ensures effortless monitoring, enhanced security, and
              better decision-making for developers and businesses alike.
            </p>
          </div>
        ...
        <div className="flex justify-center flex-wrap gap-8 px-4 md:px-10">
          <div className="w-72 h-64 p-6 bg-emerald-500 rounded-xl shadow-lg flex flex-col justify-center items-center text-white overflow-hidden group transition-transform duration-300 hover:scale-105">
            ...
            <p className="text-center text-sm text-gray-200">
              Provide real-time insights to help teams maintain high-performance
              web applications.
            </p>
          </div>
          ...
          <div className="w-72 h-64 p-6 bg-emerald-500 rounded-xl shadow-lg flex flex-col justify-center items-center text-white overflow-hidden group transition-transform duration-300 hover:scale-105">
            ...
            <p className="text-center text-sm text-gray-200">
              Offer robust logging and tracking to detect vulnerabilities and
          ...
          <div className="w-72 h-64 p-6 bg-emerald-500 rounded-xl shadow-lg flex flex-col justify-center items-center text-white overflow-hidden group transition-transform duration-300 hover:scale-105">
            ...
            <p className="text-center text-sm text-gray-200">
              Create an intuitive and seamless monitoring solution that
              integrates effortlessly into any project.
            </p>
          </div>
          ...
          <div className="w-72 h-64 p-6 bg-emerald-500 rounded-xl shadow-lg flex flex-col justify-center items-center text-white overflow-hidden group transition-transform duration-300 hover:scale-105">
            ...
            <p className="text-center text-sm text-gray-200">
              Ensure all tracking is privacy-friendly, collecting only essential
              performance and security data—never personal information.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 text-center bg-white">
        ...
        <div className="flex flex-col md:flex-row justify-around gap-8 px-4 md:px-10">
          {[
            {
              name: "Muhammed Irfan",
              github: "https://github.com/mohammedirfan244",
              pfp: "https://avatars.githubusercontent.com/u/179564628?v=4",
            },
            {
              name: "Navaf",
              github: "https://github.com/Navaf-U",
              pfp: "https://avatars.githubusercontent.com/u/179564628?v=4",
            },
            {
              name: "Fathima Harsha",
              github: "https://github.com/harsha-63",
              pfp: "https://avatars.githubusercontent.com/u/179564628?v=4",
            },
            {
              name: "Mohammed Sabik",
              github: "https://github.com/sa7ik",
              pfp: "https://avatars.githubusercontent.com/u/179564628?v=4",
            },
          ].map((member, index) => (
            <div
            ...
            >
              ...
              <h3 className="text-xl font-semibold mt-6 mb-2 text-black text-center">
                {member.name}
              </h3>
              <p className="text-black text-center text-sm">
                MERN Stack Intern Developer
              </p>
              <Image
                src={member.pfp}
                alt="Profile Picture"
