    ...
    >
      <div className="flex flex-col w-full lg:w-1/3 gap-5 relative max-lg:mb-10">
        <motion.div
          ...
          transition={{ duration: 0.4 }}
        >
          <h1 className="max-lg:text-3xl lg:text-5xl font-bold text-black">
            How our
          </h1>
          <h1 className="max-lg:text-3xl lg:text-5xl text-emerald-500 font-bold">
            service works
          </h1>
        </motion.div>
        ...
        >
          Our monitoring system ensures security, error tracking, and
          performance optimization without accessing your database.
        </motion.p>
