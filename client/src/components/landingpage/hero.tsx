...
function Hero() {
    return (
        <div className='w-full justify-between h-auto flex relative'>
            <FloatingCircle className='w-24 bg-emerald-300 bottom-20 hover:w-28 hover:h-28 transition-all left-1/4 h-24' />
            <motion.div className='flex w-[35%] h-screen px-10 flex-col gap-7 justify-center relative'>
                <h1 className='text-6xl font-bold'>Website Monitoring & Analytics</h1>
                <p className='text-[#515151] text-xl font-semibold'>Monitor, analyze, and optimize your deployed projects with a fully integrated platform.
            ...
            <div className='w-[65%] h-[800px] rounded-bl-full bg-emerald-200 relative'>
                ...
                <motion.div >
                    <Image src={device} alt='device' className='absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/3 opacity-80' />
                </motion.div>
                <motion.div >
                ...
                <motion.div >
                    <IoMdSettings className='text-emerald-500 anim absolute top-[200px] right-[150px] text-7xl' />
                </motion.div>
                <motion.div >
                    <Image src={padlock} alt='padlock' className='absolute top-[90px] right-[180px]' width={200} height={200} />
                </motion.div>
                <motion.div  >
                    <Image src={piechart} alt='piechart' className='absolute top-[200px] left-[200px]' width={100} height={100} />
                </motion.div>
                <motion.div >
