...
function Hero() {
    return (
        <div className='w-full justify-between h-auto flex'>
            <div className='flex w-[35%] h-screen px-10 flex-col gap-7 justify-center'>
                <h1 className='text-6xl font-bold'>Website Monitoring & Analytics</h1>
                <p className='text-[#515151] text-xl font-semibold'>Monitor, Analyze, and Optimize – In Real-Time. Smart project monitoring for better management.
                    Track progress, manage tasks efficiently, and stay
                    ahead with data-driven decisions
                    —all in one seamless platform</p>
                <button className='py-2 px-4 w-32 mt-5 hover:w-full hover:bg-emerald-600 transition-all duration-300 ease-out rounded-3xl bg-emerald-500 text-white'>Get Started</button>
            </div>
            <div className='w-[65%] h-[800px] rounded-bl-full bg-emerald-200 relative'>
                ...
                <IoMdSettings className='text-emerald-500 absolute bottom-[300px] left-[300px] text-5xl' />
