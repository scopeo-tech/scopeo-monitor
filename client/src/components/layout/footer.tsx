        ...
        <div className="flex flex-col md:flex-row space-y-6 md:space-y-0">
          ...
          <div className="max-w-sm text-center md:text-left md:ml-24 mb-4 md:mb-0">
            <p className="text-white text-lg max-w-sm">
              Stay ahead with smart project <br /> monitoring—insights and{" "}
              <br /> updates, right at your fingertips.
            </p>
          </div>
          ...
          <div className="md:ml-24 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              <a href="">
                <FaNpm className="text-white text-2xl hover:text-gray-300 transition" />
              </a>
              <a href="">
                <AiOutlineInstagram className="text-white text-2xl hover:text-gray-300 transition" />
              </a>
              <a href="">
